# 📊 Dashboard de Vendas — Análise Estratégica com Tableau

Este projeto apresenta um **dashboard interativo de análise de vendas**, desenvolvido no Tableau, com foco na geração de **insights estratégicos a partir de dados**.

A análise explora padrões de desempenho **geral e regional**, incluindo faturamento, lucro, comportamento do cliente e sazonalidade.
...
![Visão Geral](https://github.com/marcosengdados/ProjetoTableau/blob/main/Vis%C3%A3o%20Geral%20de%20Vendas) 
...
- Diferenças regionais impactam diretamente o lucro  
- Nem sempre maior volume representa maior rentabilidade  
- Sazonalidade influencia o desempenho de vendas  
- Segmentação de clientes gera oportunidades estratégicas  
...
📊 Data Analytics | BI | Visualização de Dados  
